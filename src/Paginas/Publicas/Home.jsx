          ...
          <main className="col-md-10">
            ...
            <div className="row">
              {productos?.map((intem, index) => (
                <div key={index} className="col-6 col-sm-3 col-lg-4 cartas">
                  <div className="card">
                    <div className="card-body">
                      ...
                      <div className="textos-cartas">
                        ...
                        <p className="card-title">{intem.marca}</p>
                        <p className="card-title">{intem.propietario}</p>
                        <p className="card-title">
                          {intem.tipo_de_combustible}
                        </p>
                        <p className="card-title">$Precio:{intem.precio}</p>
                        <p className="card-title">{intem.kilometros}</p>
                      </div>
                      <button
